...
describe('02-Función que cuenta el números de caracteres', () => {
  test('Devuelve error si no recibe un string', () => {
    expect(contarCaracteres(123)).toBe(
...
describe('05-funcion que repite un string n veces', () => {
  ...
  test('devuelve error si el número de repeticiones es negativo', () => {
    ...
    expect(resultado).toBe(
      'Error: el número de repeticiones no puede ser negativo',
    )
  })
...
describe('07-funcion que convierte texto a mayúsculas y minúsculas', () => {
  test('devuelve error si el argumento no es un string', () => {
    expect(() => convertirMayusculasMinusculas(123)).toThrow(
      'El valor "123" ingresado, No es una cadena de texto',
    )
  })
...
describe('35-funcion que simula el metodo reduce()', () => {
  test('simula el metodo reduce() sin valor inicial.', () => {
    const resultado = metodoReduce([1, 2, 3, 4], (acc, val) => acc + val)
    expect(resultado).toBe(10)
  })
